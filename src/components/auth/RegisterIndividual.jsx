          ...
          <div className="container login_container">
            <div className="row">
              <div className=" col-sm-4 col-offset-8 rounded p-4 mx-auto text-center page_desc">
                ...
                <div className="row" style={{ fontSize: "25px", marginTop:'50px' }}>
                  <div className="col-lg-4" style={{ backgroundColor:"#a01b1f" , borderRadius:'10px', textDecoration:'none', color:'black'}}>
